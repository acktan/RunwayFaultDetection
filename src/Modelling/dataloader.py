...
class DataLoader():
    ...
    def read_split_data(self):
        ...
        path_train = conf_path["model_input_path"] + conf_path["train_label_file"]
    ...
    def create_dataset(self, filenames, labels, batch_size, is_training=True):
        ...
        dataset = dataset.map(self.parse_function, num_parallel_calls=self.AUTOTUNE)
    ...
    def create_train_test(self):
        ...
        train_ds = self.create_dataset(filenames=X_train,
                                       labels=y_train,
                                       batch_size=batch_size,
                                       is_training=True)
        test_ds = self.create_dataset(filenames=X_test,
                                      labels=y_test,
                                      batch_size=batch_size,
                                      is_training=True)
